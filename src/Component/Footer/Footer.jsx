...
const Footer = () => {
  return (
    <footer className=" dark:text-base-400 shadow-top py-8">
      <div className="w-8/10 mx-auto  flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start">
          <h2 className="text-3xl font-extrabold text-[#7c3aed] tracking-wide">
            FinEase
          </h2>
          <p className="text-sm mt-1 dark:text-base-500">
